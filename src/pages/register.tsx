...
export default function RegisterPage() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      localStorage.setItem("moda_user_id", data.user.uid);
      localStorage.setItem("moda_user", JSON.stringify(data.user));
      router.push(data.user.isNew ? "/onboarding" : "/dashboard");
    } catch (err) {
      ...
      <div className="w-full max-w-md">
        ...
        >
          <svg className="w-5 h-5" viewBox="0 0 48 48">
            ...
            <path fill="#34A853" d="M24 48c6.48 0 11.93-2.13 15.89-5.81l-7.73-6c-2.15 1.45-4.92 2.3-8.16 2.3-6.26 0-11.57-4.22-13.47-9.91l-7.98 5.97C6.51 42.62 14.62 48 48 24z"/>
          </svg>
        ...
        <div className="relative mb-6">
          ...
          <div className="relative flex justify-center">
            <span className="bg-sand-bg px-4 text-label-caps text-on-surface-variant">O REGÍSTRATE CON EMAIL</span>
          </div>
        </div>
